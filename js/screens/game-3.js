...
import screenSecondGame from './game-2.js';
import screenStatsGame from './stats';

const gameThirdHtml = `<header class="header">
...
gameContent.addEventListener(`click`, () => {
  showScreen(screenStatsGame);
});

showSecondGame.addEventListener(`click`, () => {
  showScreen(screenSecondGame);
});
